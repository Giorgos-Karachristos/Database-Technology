 ...
 * @author USER
 */
public class delete_melos extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("ΔΙΑΓΡΑΦΗ ΜΕΛΟΥΣ");
        getContentPane().setLayout(new java.awt.GridBagLayout());

        jLabelMelos.setText("ΔΙΑΓΡΑΦΗ ΜΕΛΟΥΣ");
    ...
    private void jButtonDiagrafiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonDiagrafiActionPerformed
        try {
            deleteMelos(Integer.parseInt((String)jComboBoxId.getSelectedItem()));
            JOptionPane.showMessageDialog(null, "Επιτυχής διαγραφη");
            jComboBoxId.setSelectedIndex(-1);
        } catch (Exception ex) {
            Logger.getLogger(delete_melos.class.getName()).log(Level.SEVERE, null, ex);
        } 
    }//GEN-LAST:event_jButtonDiagrafiActionPerformed

    public void deleteMelos(int id) throws Exception {
        Class.forName(driverClassName);
        dbConnection = DriverManager.getConnection(url, username, passwd);

        pstatement = dbConnection.prepareStatement("BEGIN DELETE_MELOS(?); END;");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(delete_melos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new delete_melos().setVisible(true);
            }
        });
    }
