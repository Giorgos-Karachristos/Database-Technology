 ...
 * @author USER
 */
public class delete_rafiera extends javax.swing.JFrame {

    /**
     * Creates new form rafiera
     */
    public delete_rafiera() {
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("ΔΙΑΓΡΑΦΗ ΡΑΦΙΕΡΑΣ");
        getContentPane().setLayout(new java.awt.GridBagLayout());

        jLabelRafiera.setText("ΔΙΑΓΡΑΦΗ ΡΑΦΙΕΡΑΣ");
    ...
    private void jButtonDiagrafiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonDiagrafiActionPerformed
        ...
        try {
            deleteRafiera(Integer.parseInt((String)jComboBoxId.getSelectedItem()));
            JOptionPane.showMessageDialog(null, "Επιτυχής διαγραφη");
            jComboBoxId.setSelectedIndex(-1);
        } catch (Exception ex) {
            Logger.getLogger(delete_rafiera.class.getName()).log(Level.SEVERE, null, ex);
        }    
    }//GEN-LAST:event_jButtonDiagrafiActionPerformed

    public void deleteRafiera(int id) throws Exception {
        Class.forName(driverClassName);
        dbConnection = DriverManager.getConnection(url, username, passwd);

        pstatement = dbConnection.prepareStatement("BEGIN DELETE_RAFIERA(?); END;");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(delete_rafiera.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new delete_rafiera().setVisible(true);
            }
        });
    }
