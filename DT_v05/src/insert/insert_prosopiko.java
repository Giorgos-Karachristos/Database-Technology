 ...
 * @author USER
 */
public class insert_prosopiko extends javax.swing.JFrame {

    /**
     * Creates new form NewJFrame
     */
    public insert_prosopiko() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("ΕΙΣΑΓΩΓΗ ΠΡΟΣΩΠΙΚΟ");
        getContentPane().setLayout(new java.awt.GridBagLayout());

        jLabelProsopiko.setText("ΕΙΣΑΓΩΓΗ ΠΡΟΣΩΠΙΚΟ");
    ...
    private void jButtonIpoboliActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonIpoboliActionPerformed
        try {
            if (!jTextFieldId.getText().isBlank()) {
                ...
                insertProsopiko(Integer.parseInt(jTextFieldId.getText()),
            ...
            Logger.getLogger(insert_prosopiko.class.getName()).log(Level.SEVERE, null, ex);
        }

    }//GEN-LAST:event_jButtonIpoboliActionPerformed

    public void insertProsopiko(int id, String onoma, String eponimo, int tilefono, String email, Date gennisi, Date proslici) throws Exception {
        Class.forName(driverClassName);
        dbConnection = DriverManager.getConnection(url, username, passwd);

        pstatement = dbConnection.prepareStatement("BEGIN INSERT_PROSOPIKO(?,?,?,?,?,?,?); END;");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(insert_prosopiko.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new insert_prosopiko().setVisible(true);
            }
        });
    }
